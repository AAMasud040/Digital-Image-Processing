...
pred = layers.Dense(5,activation='sigmoid')(dl4)



Fmodel = Model(inputs=VGG16_MODEL.input, outputs = pred)
Fmodel.summary()
...
print("safe model 2")
# y_train_encoded[0]
history = Fmodel.fit(x_train, y_train_encoded, validation_data =(x_val, y_val_encoded), epochs=15, batch_size=1)
print("safe model 3")
